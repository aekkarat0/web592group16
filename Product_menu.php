<li class="nav nav-pills nav-stacked ">
 ...
 global $appid,$page,$title; 
  ...
  $menufile="gs://$appid/Product_menu.txt";
  if(!file_exists($menufile)){
	  ...
	  foreach($data as $line){
		  ...
		  if($s!=''){
			  ...
			  echo "<li $active><a href='Product.php?p=$key'>$icon $value</a>";
			  }
			  }   
			  if (UserService::isCurrentUserAdmin()){
				  ...
				  if($page=='edit'){
					  ...
					  echo "<li $active><a href= 'Product.php?p=edit&file=Product_menu.txt'>Edit Menu</a>";
					}
?>
<li> 
